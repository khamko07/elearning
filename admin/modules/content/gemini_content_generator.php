...
$languageSettings = [
    ...
    'lo' => [
        'name' => 'ພາສາລາວ',
        'instruction' => 'ຂຽນເນື້ອຫາທັງໝົດເປັນພາສາລາວ. ໃຊ້ພາສາທີ່ເຂົ້າໃຈງ່າຍແລະເປັນທຳມະຊາດສຳລັບຄົນລາວ',
        'sections' => [
            'intro' => 'ແນະນຳ',
            'key' => 'ແນວຄວາມຄິດຫຼັກ',
            'main' => 'ເນື້ອຫາຫຼັກ',
            'examples' => 'ຕົວຢ່າງການປະຕິບັດ',
            'best' => 'ການປະຕິບັດທີ່ດີທີ່ສຸດ',
            'mistakes' => 'ຄວາມຜິດພາດທົ່ວໄປທີ່ຄວນຫຼີກເວັ້ນ',
            'summary' => 'ສະຫຼຸບ',
            'further' => 'ອ່ານຕື່ມ'
        ]
    ]
